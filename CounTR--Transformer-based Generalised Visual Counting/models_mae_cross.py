...
class SupervisedMAE(nn.Module):
    def __init__(self, img_size=384, patch_size=16, in_chans=3,
        ...
        # Exemplar encoder with CNN   论文figure1中的 Image Encoder
    ...
    def forward_decoder(self, x, y_, shot_num=3):
        ...
        # 这里用的是crossvit中的Encoder-blocks
        # 这段对应的应该是论文中Feature Interaction Module
        # 这里的x是query image encoder的输出, 也就是query
        # y是examplars encoder后的输出，也就是key, value
