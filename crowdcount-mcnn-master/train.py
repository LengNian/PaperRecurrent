...
lr = 0.00001
momentum = 0.9
# display interval: 显示间隔, 表示每隔多少步在终端显示一次训练信息
disp_interval = 500
# log interval: 日志记录间隔, 表示每隔多少步记录一次训练信息到日志文件
log_interval = 250
...
# 使用filter来选择需要更新梯度的参数(即 requires_grad 属性为 True 的参数)
